...
// export under `/bar-for-ourcrowd`. The mirror is a fallback, not the canonical
...
//   `${NEXT_PUBLIC_BASE_PATH ?? ''}` (see src/marketing/ourcrowd/OurcrowdApp.tsx).
const isPages = process.env.GH_PAGES === "1";
const basePath = "/bar-for-ourcrowd";
